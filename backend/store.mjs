...
const dataFile = path.join(dataDir, 'rooted-store.json');
...
const seedStore = {
  ...
  readingPlans: [
    { id: 'plan_1', name: 'Bible in a Year', duration: '365 days', progress: 0.23, color: '#2E6A5C' },
    { id: 'plan_2', name: 'New Testament in 90 Days', duration: '90 days', progress: 0.58, color: '#8A6236' },
    { id: 'plan_3', name: 'Psalms & Proverbs', duration: '60 days', progress: 0.12, color: '#5D7A66' },
  ],
  quizQuestions: [
    {
      id: 'quiz_1',
